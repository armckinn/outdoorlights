...
B_TREE_LIGHTS_CH = [3, 7, 11, 15, 19, 103, 107, 111, 115, 119]
...
if __name__ == '__main__':
    r_hold = Hold(R_TREE_LIGHTS_CH, 165)
    g_hold = Hold(G_TREE_LIGHTS_CH, 42)
    b_hold = Hold(B_TREE_LIGHTS_CH, 42)

    wrapper = ClientWrapper()
    print "%s: Hold" % (str(datetime.datetime.now()))
    controller = DMXUpdater(UNIVERSE, UPDATE_INTERVAL, wrapper, [ r_hold, g_hold, b_hold ], 7*60*60*1000/UPDATE_INTERVAL)
    wrapper.Run()
